...
<div class="container-fluid px-0">
   <?= form_open_multipart(base_url('admin/addBlog')) ?>
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" class="form-control" name="title_ge">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-12">
            <textarea type="text" class="form-control form-control-sm summernote" name="text_ge" rows="12" ></textarea>
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-12">
            <textarea type="text" class="form-control form-control-sm summernote" name="text_en" rows="12" ></textarea>
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-12">
            <textarea type="text" class="form-control form-control-sm summernote" name="text_ru" rows="12" ></textarea>
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" class="form-control" name="tags_ge">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" class="form-control" name="tags_ru">
