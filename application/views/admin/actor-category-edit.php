...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
   <h3 class="h3">მსახიობის კატეგორიის დამატება</h3>
</div>

<div class="container-fluid px-0">
   <?= form_open(base_url('admin/editActorCategory/'.$id)) ?>
      <div class="form-group row">
         <label class="col-sm-2 col-form-label">დასახელება ქართულად</label>
         <div class="col-sm-10">
            <input type="text" class="form-control" name="name_ge" value="<?= $actorCategory->name_ge ?>">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" class="form-control" name="name_en" value="<?= $actorCategory->name_en ?>">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input type="text" class="form-control" name="name_ru" value="<?= $actorCategory->name_ru ?>">
