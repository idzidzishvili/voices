...
<div class="container-fluid ">
   <?= form_open(base_url('admin/contact')) ?>
      <div class="form-group row">
         <label for="staticEmail" class="col-sm-2 col-form-label">მისამართი ქართულად</label>
         <div class="col-sm-10">
      ...
      <div class="form-group row">
         <label for="staticEmail" class="col-sm-2 col-form-label">მისამართი ინგლისურად</label>
         <div class="col-sm-10">
      ...
      <div class="form-group row">
         <label for="staticEmail" class="col-sm-2 col-form-label">მისამართი რუსულად</label>
         <div class="col-sm-10">
      ...
      <div class="form-group row">
         <label for="staticEmail" class="col-sm-2 col-form-label">ტელეფონი</label>
         <div class="col-sm-10">
      ...
      <div class="form-group row">
         <label for="staticEmail" class="col-sm-2 col-form-label">ლოკაცია</label>
         <div class="col-sm-10">
